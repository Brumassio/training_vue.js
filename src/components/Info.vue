<template>
    <div>
        ...
        <ul>
            <li v-for="technology in frontend_technologies" :key="technology">
                {{ technology.language }}
            </li>
        </ul>
        ...
        <p class="teste">Para acessar meu portifólio <a :href="meu_link" target="_blank">Clique aqui !</a></p>
        <Picture/>
    </div>
</template>
    ...
    export default{
        ...
        data(){
            return{
                ...
                backend_technologies: ['C#','Python','Javascript'],
